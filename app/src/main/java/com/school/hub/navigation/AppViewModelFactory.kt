...
import com.school.hub.feature.admin.AdminViewModel
import com.school.hub.feature.auth.AuthViewModel
import com.school.hub.feature.calc.CalculatorViewModel
import com.school.hub.feature.social.SocialViewModel
...
object AppViewModelFactory {
    val Factory = viewModelFactory {
        ...
        initializer { val c = container(); AdminViewModel(c.adminRepository, c.statsStore, c.stats) }
        initializer { val c = container(); SocialViewModel(c.socialRepository, c.imageStorage) }
