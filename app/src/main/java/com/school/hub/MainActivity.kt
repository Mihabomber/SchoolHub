...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val glass by container.settings.liquidGlass.collectAsStateWithLifecycle()
            val font by container.settings.fontChoice.collectAsStateWithLifecycle()
            ...
            SchoolHubTheme(darkTheme = dark, dynamicColor = dynamic, glass = glass, font = font) { SchoolHubApp() }
        }
    }
}
